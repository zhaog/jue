...
public class ConcurrentLRUCache<K, V> {
	...
	private SegmentMap<K,V> segmentMapFor(int hash) {
        return this.segmentMaps[Math.abs(hash) % this.segmentMaps.length];
    }
	...
	private final SegmentMap<K,V>[] newSegmentMapsArray(int i) {
	...
	public class SegmentMap<K, V> extends LinkedHashMap<K, V> {
	    ...
	    protected boolean removeEldestEntry(java.util.Map.Entry<K, V> eldest) {
	        return ConcurrentLRUCache.this.size() > ConcurrentLRUCache.this.maxCapacity;
	    }
